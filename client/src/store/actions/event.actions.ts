...
import { IResponse, IEvent } from '../../models';
...
export const doListEventsSucceeded = (payload: IResponse<IEvent>): IReduxListEventsSucceededAction => ({
  type: EReduxActionTypesEvent.LIST_EVENTS_SUCCEEDED,
  payload
});

export const doListEventsFailed = (payload: IResponse<IEvent>): IReduxListEventsFailedAction => ({
  type: EReduxActionTypesEvent.LIST_EVENTS_FAILED,
  payload
});

export const doListEventsError = (payload: IResponse<IEvent>): IReduxListEventsErrorAction => ({
...
export const doAddEventSucceeded = (payload: IResponse<IEvent>): IReduxAddEventSucceededAction => ({
  type: EReduxActionTypesEvent.ADD_EVENT_SUCCEEDED,
  payload
});

export const doAddEventFailed = (payload: IResponse<IEvent>): IReduxAddEventFailedAction => ({
  type: EReduxActionTypesEvent.ADD_EVENT_FAILED,
  payload
});

export const doAddEventError = (payload: IResponse<IEvent>): IReduxAddEventErrorAction => ({
...
export const doUpdateEventSucceeded = (payload: IResponse<IEvent>): IReduxUpdateEventSucceededAction => ({
  type: EReduxActionTypesEvent.UPDATE_EVENT_SUCCEEDED,
  payload
});

export const doUpdateEventFailed = (payload: IResponse<IEvent>): IReduxUpdateEventFailedAction => ({
  type: EReduxActionTypesEvent.UPDATE_EVENT_FAILED,
  payload
});

export const doUpdateEventError = (payload: IResponse<IEvent>): IReduxUpdateEventErrorAction => ({
...
export const doRemoveEventSucceeded = (payload: IResponse<IEvent>): IReduxRemoveEventSucceededAction => ({
  type: EReduxActionTypesEvent.REMOVE_EVENT_SUCCEEDED,
  payload
});

export const doRemoveEventFailed = (payload: IResponse<IEvent>): IReduxRemoveEventFailedAction => ({
  type: EReduxActionTypesEvent.REMOVE_EVENT_FAILED,
  payload
});

export const doRemoveEventError = (payload: IResponse<IEvent>): IReduxRemoveEventErrorAction => ({
